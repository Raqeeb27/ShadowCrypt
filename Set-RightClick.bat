...
SET shadowcrypt_icon_path=%~dp0icon\ShadowCrypt.ico
...
reg add "HKEY_CLASSES_ROOT\*\shell\Hide File" /t REG_SZ /v "Icon" /d "%shadowcrypt_icon_path%" /f
...
reg add "HKEY_CLASSES_ROOT\Lnkfile\shell\Recover File" /t REG_SZ /v "Icon" /d "%shadowcrypt_icon_path%" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\Recover All" /t REG_SZ /v "Icon" /d "%shadowcrypt_icon_path%" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\Recover Files in This Folder" /t REG_SZ /v "Icon" /d "%shadowcrypt_icon_path%" /f
...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\Recover Files Recursively" /t REG_SZ /v "Icon" /d "%shadowcrypt_icon_path%" /f
